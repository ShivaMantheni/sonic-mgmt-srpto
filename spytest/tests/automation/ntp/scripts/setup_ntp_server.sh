...
# The chrony service group differs by distro/version: "chrony" (older) or
# "_chrony" (Ubuntu 24.04+). Detect whichever exists; fall back to root.
...
chown "root:${CHRONY_GROUP}" /etc/chrony/chrony.keys
