r"""
LLDP TEST - OC-1 Test ID 4.16.33: Duplicate Chassis Port Id

Test Case ID: 4.16.33
Feature: LLDP
...
def test_lldp_33_duplicate_chassis_port_id():
    """Test 4.16.33: Duplicate Chassis Port Id"""
    st.banner("TEST 4.16.33: Duplicate Chassis Port Id")
    ...
    if "PASS" in manual_result:
        ...
        st.report_unsupported("msg", f"Test 4.16.33: {manual_result}")
    else:
        st.log(f"✗ Test marked as FAIL in manual testing: {manual_result}")
        st.report_fail("msg", f"Test 4.16.33: {manual_result}")
