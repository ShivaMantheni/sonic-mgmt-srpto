# Test Case: PB-F-005 - IP Configuration on Breakout Ports

## Test ID
**PB-F-005**

## Test Objective
Verify IPv4/IPv6 address configuration on child ports after breakout

## Test Description
This test validates ip configuration on breakout ports functionality.
...
**Test File:** `test_pb_f_005_ip_configuration.py`
