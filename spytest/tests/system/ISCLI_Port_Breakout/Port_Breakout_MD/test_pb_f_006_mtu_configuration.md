# Test Case: PB-F-006 - MTU Configuration on Breakout Ports

## Test ID
**PB-F-006**

## Test Objective
Verify MTU/jumbo frame configuration on child ports

## Test Description
This test validates mtu configuration on breakout ports functionality.
...
**Test File:** `test_pb_f_006_mtu_configuration.py`
