...
## Test Objective
Verify basic L2/L3 connectivity on breakout ports

## Test Description
This test validates basic connectivity test functionality.
...
**Test File:** `test_pb_f_016_basic_connectivity.py`
