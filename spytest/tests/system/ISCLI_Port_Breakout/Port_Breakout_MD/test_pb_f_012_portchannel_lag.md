...
## Test Objective
Verify PortChannel creation using breakout child ports

## Test Description
This test validates portchannel/lag with breakout ports functionality.
...
**Test File:** `test_pb_f_012_portchannel_lag.py`
