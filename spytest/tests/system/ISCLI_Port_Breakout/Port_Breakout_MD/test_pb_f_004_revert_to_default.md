# Test Case: PB-F-004 - Revert to Default Breakout

## Test ID
**PB-F-004**

## Test Objective
Verify port can be reverted to default 1x800G configuration

## Test Description
This test validates revert to default breakout functionality.
...
**Test File:** `test_pb_f_004_revert_to_default.py`
