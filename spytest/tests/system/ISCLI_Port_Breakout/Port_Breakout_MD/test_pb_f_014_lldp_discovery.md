...
## Test Objective
Verify LLDP neighbor discovery on child ports

## Test Description
This test validates lldp discovery on breakout ports functionality.
...
**Test File:** `test_pb_f_014_lldp_discovery.py`
