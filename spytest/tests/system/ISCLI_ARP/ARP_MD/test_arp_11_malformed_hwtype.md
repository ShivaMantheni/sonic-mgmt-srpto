# Test Case: ARP-013 - Malformed ARP Hardware Type

## Test ID
**ARP-013**

## Test Objective
Verify handling of malformed ARP hardware type

## Test Description
This test validates malformed arp hardware type functionality.
...
**Test File:** `test_arp_11_malformed_hwtype.py`
