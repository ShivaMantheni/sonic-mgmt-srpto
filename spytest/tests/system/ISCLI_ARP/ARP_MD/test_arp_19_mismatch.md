# Test Case: ARP-021 - ARP MAC/IP Mismatch

## Test ID
**ARP-021**

## Test Objective
Verify handling of MAC/IP address mismatches

## Test Description
This test validates arp mac/ip mismatch functionality.
...
**Test File:** `test_arp_19_mismatch.py`
