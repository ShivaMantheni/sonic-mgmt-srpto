# Test Case: ARP-017 - ARP Across Different Subnets

## Test ID
**ARP-017**

## Test Objective
Verify ARP behavior across different subnets

## Test Description
This test validates arp across different subnets functionality.
...
**Test File:** `test_arp_15_different_subnet.py`
