# Test Case: ARP-012 - Malformed ARP Opcode

## Test ID
**ARP-012**

## Test Objective
Verify handling of malformed ARP opcode

## Test Description
This test validates malformed arp opcode functionality.
...
**Test File:** `test_arp_10_malformed_opcode.py`
