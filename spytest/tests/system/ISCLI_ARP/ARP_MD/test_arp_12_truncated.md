# Test Case: ARP-014 - Truncated ARP Packets

## Test ID
**ARP-014**

## Test Objective
Verify handling of truncated ARP packets

## Test Description
This test validates truncated arp packets functionality.
...
**Test File:** `test_arp_12_truncated.py`
