# Test Case: ARP-008 - ARP on VLAN Interfaces

## Test ID
**ARP-008**

## Test Objective
Verify ARP functionality on VLAN interfaces

## Test Description
This test validates arp on vlan interfaces functionality.
