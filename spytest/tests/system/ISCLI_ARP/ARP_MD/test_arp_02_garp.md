# Test Case: ARP-003 - Gratuitous ARP (GARP)

## Test ID
**ARP-003**

## Test Objective
Verify Gratuitous ARP sending and receiving

## Test Description
This test validates gratuitous arp (garp) functionality.
