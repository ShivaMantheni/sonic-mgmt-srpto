# Test Case: ARP-020 - ARP with Unicast Destination

## Test ID
**ARP-020**

## Test Objective
Verify ARP with unicast destination address

## Test Description
This test validates arp with unicast destination functionality.
...
**Test File:** `test_arp_18_unicast_dst.py`
