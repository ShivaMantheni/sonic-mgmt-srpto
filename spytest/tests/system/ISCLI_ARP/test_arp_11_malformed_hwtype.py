"""
Test ID: 4.17.11
Test Case: Verify Malformed ARP - Wrong Hardware Type
Test Item: Negative
Test Objective: Validate system handling of ARP with invalid hardware type
"""
...
CONFIG.dut1_ip = "10.11.1.1/24"
CONFIG.dut2_ip = "10.11.1.2/24"
CONFIG.invalid_hwtype = 999
CONFIG.script_file = "/tmp/scenario11_malformed_hwtype.py"


@pytest.fixture(scope="module", autouse=True)
def arp_malformed_hwtype_module_hooks(request):
    global vars, data
...
def test_arp_malformed_hwtype():
    """
    Test ID: 4.17.11
    Expected Result: System drops packets with invalid hardware type
    """
    result = True
    try:
        st.log("Test: Verify Malformed ARP - Wrong Hardware Type")
...
print("[*] Scenario 11: Malformed ARP - Wrong Hardware Type")
print(f"[*] Sending ARP with invalid hwtype {CONFIG.invalid_hwtype}")

malformed_arp = Ether(src=src_mac, dst="ff:ff:ff:ff:ff:ff") / ARP(
    hwtype={CONFIG.invalid_hwtype},
    op=1,
    hwsrc=src_mac,
    psrc=src_ip,
