# Test Case: ND-001 - Basic ND Operations

## Test ID
**ND-001**

## Test Objective
Verify basic IPv6 Neighbor Discovery operations

## Test Description
This test validates basic nd operations functionality.
...
**Test File:** `test_nd_basic_operations.py`
