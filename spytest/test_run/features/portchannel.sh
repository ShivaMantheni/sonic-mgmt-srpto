...
run_portchannel_test "PORTCHANNEL_ISCLI" "./testbeds/QA/testbed_2node_reg_qa.yaml" \
...
run_portchannel_test "PORTCHANNEL_LACP" "./testbeds/QA/testbed_vs_1node_reg_qa.yaml" \
