...
run_qos_test "QOS_PFC_PRIORITY_PG_MAP" "./testbeds/QA/testbed_vs_2d_reg_qa.yaml" \
...
run_qos_test "QOS_PFC_PG_MAP_NEGATIVE" "./testbeds/QA/testbed_vs_1node_reg_qa.yaml" \
...
run_qos_test "QOS_PFC_PG_MAP_CONFIG" "./testbeds/QA/testbed_vs_1node_reg_qa.yaml" \
...
run_qos_test "QOS_PFC_PG_MAP_PERSISTENCE" "./testbeds/QA/testbed_vs_1node_reg_qa.yaml" \
...
run_qos_test "QOS_DELETE_ACTIVE_PFC" "./testbeds/QA/testbed_vs_1node_reg_qa.yaml" \
