...
run_arp_test "ARP_COMPREHENSIVE" "./testbeds/QA/testbed_2vs_reg_qa.yaml" \
...
run_arp_test "ARP_EXTENDED" "./testbeds/QA/testbed_2vs_reg_qa.yaml" \
...
run_arp_test "ARP_TABLE_VERIFICATION" "./testbeds/QA/ztp_standalone_reg_qa.yaml" \
