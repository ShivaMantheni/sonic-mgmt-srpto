...
run_bgp_test "BGP_NEG_FLAP_RR" "./testbeds/QA/testbed_vs_3rr_reg_qa.yaml" \
...
run_bgp_test "BGP_IPV4_FEATURES" "./testbeds/QA/testbed_vs_2node_reg_qa.yaml" \
...
run_bgp_test "BGP_ADVANCED_FEATURES" "./testbeds/QA/testbed_vs_3rr_reg_qa.yaml" \
...
run_bgp_test "BGP_ISCLI_BESTPATH" "./testbeds/QA/testbed_2vs_reg_qa.yaml" \
...
run_bgp_test "BGP_ISCLI_CAPABILITY" "./testbeds/QA/testbed_2vs_reg_qa.yaml" \
...
run_bgp_test "BGP_ISCLI_PG_ADV" "./testbeds/QA/testbed_2vs_reg_qa.yaml" \
