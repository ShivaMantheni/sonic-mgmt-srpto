...
run_ntp_test() {
    ...
    export NTP_ISCLI_VAR_FILE=./tests/system/ntp/vars_ntp_iscli_local_reg_qa.yaml
...
run_ntp_test "NTP_BASIC" "./testbeds/QA/testbed_vs_1node_reg_qa.yaml" \
...
run_ntp_test "NTP_EXTENDED" "./testbeds/QA/testbed_vs_1node_reg_qa.yaml" \
