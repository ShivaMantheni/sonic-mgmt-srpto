...
run_lldp_test "LLDP_COMPREHENSIVE" "./testbeds/testbed_vs_2d.yaml" \
...
run_lldp_test "SM_ISCLI_52_LLDP_CLI_VALIDATION" "./testbeds/testbed_vs_2d.yaml" \
...
run_lldp_test "SM_ISCLI_P2_161_162_LLDP_CLI_FIX" "./testbeds/testbed_vs_1node.yaml" \
