...
run_acl_test "IPV4_ACL_CLI" "./testbeds/ztp_standalone.yaml" \
...
run_acl_test "L3_ACL_COMPREHENSIVE" "./testbeds/testbed_acl.yaml" \
...
run_acl_test "L2_ACL_COMPREHENSIVE" "./testbeds/testbed_acl.yaml" \
...
run_acl_test "MAC_ACL_COMPREHENSIVE" "./testbeds/ztp_standalone.yaml" \
