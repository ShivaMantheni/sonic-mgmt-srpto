...
run_static_test "STATIC_BASIC" "./testbeds/testbed_vs_1node.yaml" \
...
run_static_test "STATIC_IPV6" "./testbeds/testbed_vs_1node.yaml" \
...
run_static_test "STATIC_OC_COMPREHENSIVE" "./testbeds/testbed_oc_static_3vs.yaml" \
