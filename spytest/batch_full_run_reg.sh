...
if should_run_batch "A"; then
    run_batch "BGP_NEG_FLAP_RR" "./testbeds/testbed_vs_3rr_reg.yaml" \
...
if should_run_batch "B"; then
    ...
    run_bgp_batch "BGP_IPV4_FEATURES_3RR" "./testbeds/testbed_vs_3rr_reg.yaml" \
...
if should_run_batch "C"; then
    run_batch "BGP_ISCLI_BESTPATH" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "D"; then
    run_batch "BGP_ISCLI_CAPABILITY" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "E"; then
    run_batch "BGP_ISCLI_EVPN" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "F"; then
    run_batch "BGP_ISCLI_PG_ADV" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "M"; then
    ...
    run_batch "SYS_NTP" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "N"; then
    run_batch "STATIC_ROUTING" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "O"; then
    run_batch "SM_ISCLI_7_STATIC_ROUTES" "./testbeds/testbed_vs_1node_reg.yaml" \
    routing/static/test_sm_iscli_7.py
else
...
if should_run_batch "P"; then
    run_batch "SM_ISCLI_4_EBGP_MULTIHOP" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "Q"; then
    run_batch "SM_ISCLI_5_BGP_L2VPN_EVPN" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "R"; then
    run_batch "SM_ISCLI_6_BGP_TIMERS" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "S"; then
    run_batch "SM_ISCLI_59_MGMT_IP_ROUTE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "T"; then
    run_batch "SM_ISCLI_43_SM_ISCLI_61_MGMT_INTERFACE_CONFIG" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "U"; then
    run_batch "SM_ISCLI_42_SM_ISCLI_68_VLAN_BASIC_CONFIG" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "V"; then
    run_batch "SM_ISCLI_16_IP_NOOP" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "W"; then
    run_batch "SM_ISCLI_60_VLAN_INTERFACE_LIFECYCLE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "X"; then
    run_batch "SM_ISCLI_66_SWITCHING_MODE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "Y"; then
    run_batch "SM_ISCLI_8_MGMT_STATIC_IP" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "Z"; then
    run_batch "SM_ISCLI_9_L2VPN_EVPN_ORDER" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AA"; then
    run_batch "SM_ISCLI_11_BGP_GRACEFUL_RESTART" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AB"; then
    run_batch "SM_ISCLI_12_MGMT_PORT_VISIBLE" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AC"; then
    run_batch "SM_ISCLI_10_UPDATE_SOURCE" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AD"; then
    run_batch "SM_ISCLI_13_IBGP_MULTIPATH" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AE"; then
    run_batch "SM_ISCLI_15_BGP_NETWORK_CONFLICT" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AF"; then
    run_batch "SM_ISCLI_41_BGP_REMOTE_AS_INTERNAL_EXTERNAL" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AG"; then
    run_batch "SM_ISCLI_82_BGP_VRF_VALIDATION" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AH"; then
    run_batch "SM_ISCLI_74_HOSTNAME_VALIDATION" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AI"; then
    run_batch "SM_ISCLI_29_IP_ROUTE_SVI" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AJ"; then
    run_batch "SM_ISCLI_46_PORT_BREAKOUT" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AK"; then
    run_batch "SM_ISCLI_60_REMOVE_VLAN_INTERFACE" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AL"; then
    run_batch "SM_ISCLI_12_SHOW_IP_INTERFACE" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AM"; then
    run_batch "SM_ISCLI_33_SHOW_RUN_INTERFACE" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AN"; then
    run_batch "SM_ISCLI_54_SHOW_RUNNING_CONFIG" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AO"; then
    run_batch "SM_ISCLI_73_VRF_INTERFACE_VALIDATION" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AP"; then
    run_batch "SM_ISCLI_19_GREP_FILTER" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "AQ"; then
    run_batch "SM_ISCLI_20_OSPF_LOOPBACK_NO_IP" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AR"; then
    run_batch "SM_ISCLI_34_SM_ISCLI_32_SM_ISCLI_31_INTERFACE_IP_CONFIG" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "AS"; then
    run_batch "SM_ISCLI_24_SONIC_CLI_C_FLAG" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "AT"; then
    run_batch "SM_ISCLI_23_ROUTE_MAP_SHOW_RUN" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "AU"; then
    run_batch "SM_ISCLI_82_BGP_VRF_UNCONFIG" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "AV"; then
    run_batch "SM_ISCLI_48_SM_ISCLI_49_SM_ISCLI_51_IPV4_ACL_CLI" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "AW"; then
    run_batch "SM_ISCLI_69_VLAN_NEGATIVE_MEMBER" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AX"; then
    run_batch "SM_ISCLI_76_SHOW_IP_ROUTE_FILTERING" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AY"; then
    run_batch "SM_ISCLI_21_OSPF_NETWORK_REMOVAL" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "AZ"; then
    run_batch "SM_ISCLI_27_BGP_PEERGROUP_ACTIVATE" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "BB"; then
    run_batch "SM_ISCLI_53_HOSTNAME_CONFIG_VERIFICATION" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "BC"; then
    run_batch "SM_ISCLI_70_BGP_IPV6_CLI_VALIDATION" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "BD"; then
    run_batch "SM_ISCLI_72_IPV6_INTERFACE_ENABLE_DISABLE" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "BE"; then
    run_batch "SM_ISCLI_76_IP_ROUTE_SHOW_COMMANDS" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BF"; then
    run_batch "SM_ISCLI_77_VRF_CLI_NEGATIVE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BG"; then
    run_batch "SM_ISCLI_25_INTERFACE_DESC_QUOTES" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "BH"; then
    run_batch "SM_ISCLI_78_LOOPBACK_INTERFACE_CONFIG" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BI"; then
    run_batch "SM_ISCLI_26_PLATFORM_INTERFACE_CLI" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "BJ"; then
    run_batch "SM_ISCLI_28_BGP_SHOW_CONFIG" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "BK"; then
    run_batch "SM_ISCLI_VRF_BASIC" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BL"; then
    run_batch "SM_ISCLI_P2_78_LACP_FAST_RATE" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "BM"; then
    run_batch "SM_ISCLI_VRF_INTERFACE_NEGATIVE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BN"; then
    run_batch "SM_ISCLI_VRF_LOOPBACK_PORTCHANNEL_NEGATIVE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BO"; then
    run_batch "SM_ISCLI_VRF_PING" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BP"; then
    run_batch "SM_ISCLI_VRF_IP_INTERFACE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BQ"; then
    run_batch "SM_ISCLI_IP_PREFIX_LIST" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BR"; then
    run_batch "SM_ISCLI_ARP_TABLE_VERIFICATION" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BS"; then
    run_batch "SM_ISCLI_INTERFACE_CLI_VERIFICATION" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BT"; then
    run_batch "SM_ISCLI_ROUTE_MAP_DEPENDENCY" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "BU"; then
    run_batch "SM_ISCLI_P2_42_VLAN_SVI_REMOVAL" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "BV"; then
    run_batch "SM_ISCLI_P2_39_SWITCHPORT_TRUNK_VLAN" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "BW"; then
    run_batch "SM_ISCLI_13_VRF_BINDING" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "BX"; then
    run_batch "SM_ISCLI_P2_32_BGP_VRF_INSTANCE" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "BY"; then
    run_batch "SM_ISCLI_44_COPY_COMMAND" "./testbeds/testbed_vs_3rr_reg.yaml" \
...
if should_run_batch "BZ"; then
    run_batch "SM_ISCLI_40_BGP_EBGP_REQUIRES_POLICY" "./testbeds/testbed_vs_3rr_reg.yaml" \
...
if should_run_batch "CA"; then
    run_batch "SM_ISCLI_45_WRITE_ERASE_COMMAND" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "CB"; then
    run_batch "SM_ISCLI_VRF_ROUTE_MAP_VALIDATION" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "CC"; then
    run_batch "SM_ISCLI_IPV6_INTERFACE_REDIS_VALIDATION" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "CD"; then
    run_batch "SM_ISCLI_MGMT_INTERFACE_IPV6_NEIGHBOR" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "CE"; then
    run_batch "SM_ISCLI_MAC_ACL_COMPREHENSIVE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "CF"; then
    run_batch "SM_ISCLI_P2_161_162_LLDP_CLI_FIX" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "CG"; then
    run_batch "QOS_PFC_PRIORITY_PG_MAP" "./testbeds/testbed_vs_2d_reg.yaml" \
...
if should_run_batch "CH"; then
    run_batch "QOS_PFC_PG_MAP_NEGATIVE" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "CI"; then
    run_batch "QOS_PFC_PG_MAP_CONFIG" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "CJ"; then
    run_batch "QOS_PFC_PG_MAP_PERSISTENCE" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "CK"; then
    run_batch "L3_ACL_COMPREHENSIVE" "./testbeds/testbed_acl_reg.yaml" \
...
if should_run_batch "CL"; then
    run_batch "L2_ACL_COMPREHENSIVE" "./testbeds/testbed_acl_reg.yaml" \
...
if should_run_batch "CM"; then
    run_batch "VLAN_SVI_L3_TRAFFIC" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "CN"; then
    run_batch "VLAN_COMPREHENSIVE" "./testbeds/testbed_vs_2d_reg.yaml" \
    ...
    run_batch "VLAN_COMPREHENSIVE_STANDALONE" "./testbeds/ztp_standalone_reg.yaml" \
...
if should_run_batch "CO"; then
    run_batch "ARP_COMPREHENSIVE" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "CP"; then
    run_batch "PORT_BREAKOUT_COMPREHENSIVE" "./testbeds/testbed_sm18_hw_reg.yaml" \
...
if should_run_batch "CQ"; then
    run_batch "PORT_BREAKOUT_ISCLI_EXTENDED" "./testbeds/testbed_sm18_hw_reg.yaml" \
...
if should_run_batch "CR"; then
    run_batch "ARP_EXTENDED_TESTS" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "CS"; then
    run_batch "ND_NEIGHBOR_DISCOVERY" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "CT"; then
    run_batch "LLDP_COMPREHENSIVE" "./testbeds/testbed_2vs_reg.yaml" \
...
if should_run_batch "CU"; then
    run_batch "NTP_EXTENDED_TESTS" "./testbeds/testbed_vs_1node_ntp_reg.yaml" \
...
if should_run_batch "CV"; then
    run_batch "QOS_DELETE_ACTIVE_PFC" "./testbeds/testbed_vs_1node_reg.yaml" \
...
if should_run_batch "CW"; then
    run_batch "PORT_BREAKOUT_ISCLI_COMPREHENSIVE" "./testbeds/testbed_sm18_hw_reg.yaml" \
...
if should_run_batch "CX"; then
    ...
    run_batch "OSPFV2_BASIC_ADJACENCY" "./testbeds/testbed_ospfv2_hw_2dut_reg.yaml" \
    ...
    run_batch "OSPFV2_LSA_LSDB" "./testbeds/testbed_ospfv2_vs_4node_reg.yaml" \
    routing/ospf/test_ospfv2_lsa_lsdb.py \
    routing/ospf/test_ospfv2_virtual_link.py

    # OSPFv2 Area Types (3-node hardware testbed)
    run_batch "OSPFV2_AREA_TYPES" "./testbeds/testbed_ospfv2_hw_3node_reg.yaml" \
    routing/ospf/test_ospfv2_area_types.py

    # OSPFv2 Routes and SPF (virtual testbed)
    run_batch "OSPFV2_ROUTES_SPF" "./testbeds/testbed_ospfv2_routes_spf_vs_reg.yaml" \
...
if should_run_batch "CY"; then
    run_batch "VLAN_DELETE_TESTS" "./testbeds/testbed_vs_3d_reg.yaml" \
...
if should_run_batch "CZ"; then
    run_batch "STATIC_ROUTE_OC_COMPREHENSIVE" "./testbeds/testbed_oc_static_3vs_reg.yaml" \
